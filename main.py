...
# ============================================================
TOPICS = [
    "Акриловый камень: что это такое и почему он лучше искусственного мрамора",
    "Столешница из акрилового камня: плюсы и минусы для кухни",
    "Как выбрать подоконник — пластик, дерево или акриловый камень",
    "5 причин заказать столешницу из акрилового камня, а не из ДСП",
    "Уход за акриловым камнем: как сохранить идеальный вид на годы",
    "Бесшовные столешницы — почему это удобно и практично",
    "Акриловый камень для ванной: столешницы, подоконники, экраны",
    "Какие цвета и текстуры акрилового камня сейчас популярны",
    "Ремонт царапин и сколов на акриловом камне своими руками",
    "Чем акриловый камень отличается от кварцевого агломерата",
    "Подоконник как продолжение столешницы — современное решение",
    "Сколько стоит столешница из акрилового камня и от чего зависит цена",
    "Декоративные панели для интерьера — тренды сезона",
    "Как акриловый камень меняет облик кухни и ванной комнаты",
    "Заказ мебели из акрилового камня — с чего начать",
]
